...
import { loanRequestSchema, loanReviewSchema, loanSchema, repaymentSchema } from '../validators/schemas.js';

const router = Router();

router.get('/eligibility', authorize('MEMBER', 'TREASURER', 'CHAIRMAN'), controller.checkEligibility);
router.get('/requests', authorize('MEMBER', 'TREASURER', 'CHAIRMAN'), controller.listLoanRequests);
